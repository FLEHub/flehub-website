...
import { GalleryEditor } from '@/components/galleries/gallery-editor'
    ...
    <div className="p-6 space-y-6 max-w-3xl mx-auto">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Créez un album photo en brouillon ou publiez-le sur le portail.
        </p>
      </div>
      <GalleryEditor categories={(categories ?? []) as ArticleCategory[]} />
    </div>
  )
}
