                  ...
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex flex-wrap gap-1.5 justify-end">
                      ...
                      {learner.examScores.length > 0 && (
                        <Badge className="bg-[#E8F1FA] text-[#1E5FA8] hover:bg-[#E8F1FA]">
                ...
                <CardContent className="space-y-5">
                  ...
                  <div className="border-t border-gray-100 pt-4 space-y-3">
                    <div className="flex items-center gap-2">
                      <div className="w-7 h-7 rounded-lg bg-[#E8F1FA] flex items-center justify-center">
                        <ClipboardList className="w-3.5 h-3.5 text-[#1E5FA8]" />
                      </div>
                      <div>
                    ...
                    <div className="space-y-3 rounded-lg border border-gray-100 bg-gray-50/60 p-3">
                          ...
                          {EXAM_COMPS.map((c) => (
                            <div key={c.key} className="space-y-1">
                              ...
                              <Input
                                ...
                                className="text-center px-1 bg-white border-gray-200 focus:border-[#1E5FA8]"
                              />
                            </div>
                          ))}
                        </div>
                      ...
                      <Button
                        className="w-full sm:w-auto bg-[#1E5FA8] hover:bg-[#164A82] text-white"
                    ...
                    {canGenerateCert && selectedScore && (
                      <div className="rounded-lg border border-[#1E5FA8]/25 bg-[#E8F1FA]/50 px-3 py-3 space-y-2">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                          <div>
                            <p className="text-sm font-semibold text-gray-900 flex items-center gap-1.5">
                              <Award className="w-4 h-4 text-[#1E5FA8]" />
                  ...
                  {successByLearner[learner.id] && (
                    <p className="text-sm text-[#164A82] bg-[#E8F1FA] border border-[#1E5FA8]/30 rounded-md px-3 py-2">
                      {successByLearner[learner.id]}
                    </p>
                  )}
