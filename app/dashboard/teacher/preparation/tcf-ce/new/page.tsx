...
export default function NewTcfCeSessionPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      router.push(
        `/dashboard/teacher/preparation/tcf-ce/${data.id}/questions`
      );
    } catch (err) {
      console.error(err);
      setError(
    ...
    <div className="p-6 space-y-6 max-w-2xl mx-auto">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Définissez le titre et la durée, puis ajoutez les questions avec
          image de texte (chaque question aura son propre niveau).
        </p>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="Ex. TCF CE — Entraînement complet"
                disabled={saving}
                required
              />
            </div>
