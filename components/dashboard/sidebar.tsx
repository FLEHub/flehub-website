...
const navByRole: Record<Role, NavItem[]> = {
  admin: [
    ...
    { label: 'Exam Papers', href: '/dashboard/admin/exam-papers', icon: FileText },
    { label: 'School Results', href: '/dashboard/admin/results', icon: Award },
  ...
  school: [
    ...
    { label: 'Résultats', href: '/dashboard/school/results', icon: FileText },
