...
Léa m'en a prêté un.""",
        ...
        error=(
            "Joël a préparé des seaux avant que l'eau monte.",
            "Joël avait préparé des seaux avant que l'eau monte.",
...
Je suis heureux de revenir.""",
        ...
        error=(
            "C'est difficile de faire sur la rive.",
            "C'est difficile à faire sur la rive.",
...
Je suis de moins en moins d'accord avec les sacs trop lourds.""",
        ...
        error=(
            "Je suis de plus en plus fier, écrit Léa.",
            "Je suis de plus en plus fière, écrit Léa.",
