#!/usr/bin/env python3
"""Build idempotent SQL seeds for all MFK A2 modules."""
...
PACKS = [
    ("m1", "20260829180000_elearning_mfk_a2_module1_escale_france.sql"),
    ("m2", "20260829180100_elearning_mfk_a2_module2_aventures_partagees.sql"),
    ("m3", "20260829180200_elearning_mfk_a2_module3_metier_francais.sql"),
    ("m4", "20260829180300_elearning_mfk_a2_module4_cultures_partage.sql"),
    ("m5", "20260829180400_elearning_mfk_a2_module5_vivre_ensemble.sql"),
    ("m6", "20260829180500_elearning_mfk_a2_module6_petits_gestes.sql"),
    ("m7", "20260829180600_elearning_mfk_a2_module7_memoire_engagement.sql"),
    ("m8", "20260829180700_elearning_mfk_a2_module8_monde_direct.sql"),
]
