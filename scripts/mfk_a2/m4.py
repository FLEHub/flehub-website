...
Seuil des Sources — Rukiri-Nord""",
        ...
        error=(
            "J'ai cousu déjà un tissu trop tard ici maintenant.",
            "J'ai déjà cousu un tissu.",
...
Hawa : Où se trouve le micro, s'il vous plaît ?""",
        ...
        error=(
            "Pouvez vous expliquer la danse sans trait ?",
...
On ne dit pas : je voudrais de danser — je voudrais danser.""",
        ...
        error=(
            "Je voudrais de danser encore une fois ce soir trop.",
            "Je voudrais danser.",
