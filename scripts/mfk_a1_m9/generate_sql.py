#!/usr/bin/env python3
"""Build the idempotent SQL seed for MFK A1 Module 9 from content.py."""
...
OUT = ROOT / "supabase/migrations/20260829140000_elearning_mfk_a1_module9_chemin_parcouru.sql"
...
def validate() -> None:
    svg_dir = ROOT / "public/elearning/mfk-a1-m9"
    used: set[str] = set()
