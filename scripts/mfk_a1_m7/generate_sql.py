#!/usr/bin/env python3
"""Build the idempotent SQL seed for MFK A1 Module 7 from content.py."""
...
OUT = ROOT / "supabase/migrations/20260827160000_elearning_mfk_a1_module7_cap_ailleurs.sql"
...
def validate() -> None:
    svg_dir = ROOT / "public/elearning/mfk-a1-m7"
    used: set[str] = set()
