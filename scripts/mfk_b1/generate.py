#!/usr/bin/env python3
"""Build idempotent SQL seeds for all MFK B1 modules."""
...
PACKS = [
    ("m1", "20260830120000_elearning_mfk_b1_module1_ailleurs_nouveau_chez_soi.sql"),
    ("m2", "20260830120100_elearning_mfk_b1_module2_sinstaller_autrement.sql"),
    ("m3", "20260830120200_elearning_mfk_b1_module3_organiser_la_fete.sql"),
    ("m4", "20260830120300_elearning_mfk_b1_module4_agir_pour_demain.sql"),
    ("m5", "20260830120400_elearning_mfk_b1_module5_etudier_travailler.sql"),
    ("m6", "20260830120500_elearning_mfk_b1_module6_sinformer_sexprimer.sql"),
    ("m7", "20260830120600_elearning_mfk_b1_module7_esprit_innovation.sql"),
    ("m8", "20260830120700_elearning_mfk_b1_module8_monde_de_culture.sql"),
]
