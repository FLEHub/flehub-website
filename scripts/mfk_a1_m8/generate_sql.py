#!/usr/bin/env python3
"""Build the idempotent SQL seed for MFK A1 Module 8 from content.py."""
...
OUT = ROOT / "supabase/migrations/20260829120000_elearning_mfk_a1_module8_gestes_quotidien.sql"
...
def validate() -> None:
    svg_dir = ROOT / "public/elearning/mfk-a1-m8"
    used: set[str] = set()
    ...
    missing_from_lessons = available - used
    if missing_from_lessons:
        raise ValueError(f"Unused SVGs: {sorted(missing_from_lessons)}")
