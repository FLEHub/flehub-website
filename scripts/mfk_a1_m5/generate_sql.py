#!/usr/bin/env python3
"""Build the idempotent SQL seed for MFK A1 Module 5 from content.py."""
...
OUT = ROOT / "supabase/migrations/20260827120000_elearning_mfk_a1_module5_fil_journees.sql"
