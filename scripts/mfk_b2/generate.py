#!/usr/bin/env python3
"""Build idempotent SQL seeds for all MFK B2 modules."""
...
PACKS = [
    ("m1", "20260830140000_elearning_mfk_b2_module1_tendances_seuil.sql"),
    ("m2", "20260830140100_elearning_mfk_b2_module2_memoire_seuil.sql"),
    ("m3", "20260830140200_elearning_mfk_b2_module3_culture_commune.sql"),
    ("m4", "20260830140300_elearning_mfk_b2_module4_vivre_technologie.sql"),
    ("m5", "20260830140400_elearning_mfk_b2_module5_questions_societe.sql"),
    ("m6", "20260830140500_elearning_mfk_b2_module6_evoluer_societe.sql"),
    ("m7", "20260830140600_elearning_mfk_b2_module7_agir_travail.sql"),
    ("m8", "20260830140700_elearning_mfk_b2_module8_modeles_educatifs.sql"),
]
