#!/usr/bin/env python3
"""Build the idempotent SQL seed for MFK A1 Module 4 from content.py."""
...
OUT = ROOT / "supabase/migrations/20260823210000_elearning_mfk_a1_module4_portraits_croises.sql"
